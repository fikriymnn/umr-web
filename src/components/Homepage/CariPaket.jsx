...
function CariPaket() {
  return (
    <div>
      <div className="md:mt-0 mt-5 md:py-0 py-3 bg-white  rounded-[10px] shadow md:w-9/12 w-11/12 md:h-28 mx-auto md:-translate-y-7 md:flex gap-2 items-center grid grid-cols-3 px-5">
        <div className="md:w-[25%] ">
          <p className="lg:w-full md:w-full sm:w-11/12 w-8/12  md:text-base sm:text-sm text-[10px] ">
        ...
        <div className="md:mt-5 w-full col-span-3 md:w-[20%] mb-1 flex justify-center">
