          ...
          <div className="bg-white grid grid-cols-1 gap-3 md:rounded-xl rounded-b-xl border-2 md:border-t-2 border-t-0 border-slate-300 shadow-xl p-3 px-8">
            <div className="flex justify-center items-center md:gap-32 gap-3 pt-3">
              <div className="flex flex-col">
                <button className="text-[#E3B02B]">Belum Bayar</button>
                <div className="h-[2px] bg-[#E3B02B]"></div>
              </div>
              <div className="flex flex-col">
                <button className="text-black">Diproses</button>
                <div className=""></div>
              </div>
              <div className="flex flex-col">
                <button className="text-black">Selesai</button>
                <div className=""></div>
              </div>
            </div>
            <div className="my-4">
                ...
                <div className="grid md:grid-cols-2 grid-cols-1 gap-5 mt-5">
                  ...
                  <div className="flex">
                    ...
                    <div>
                      ...
                      <p className="ps-1 pt-2 md:text-xl text-black">9 Hari</p>
                    </div>
                  </div>
                  <div className="flex">
                    <div className="w-1/12">
              ...
              <div className="flex md:flex-row flex-col">
                ...
                <div className="border-2 p-2 border-slate-200 md:w-[70%] md:border-t-2 border-t-0 text-2xl font-bold px-12 py-3 flex md:flex-row flex-col justify-between ">
                  ...
                  <button className="bg-[#E3B02B] px-7 rounded-lg md:py-0 py-2 md:mt-0 mt-2 ">
                    Bayar
                  </button>
                </div>
              </div>
