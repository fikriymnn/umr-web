                    ...
                    <div className='  md:p-10 px-5 pt-10'>
                        <div className='flex py-1 '>
                            ...
                            <div className='w-10/12 ps-5'>
                                <h1 className=' text-black md:text-3xl text-xl pb-3 font-semibold'>Travel Keren Dongs</h1>
                                ...
                                <p className='text-black md:text-xl text-sm pb-1'>Nomor Izin Umroh:</p>
                                <p className='text-black md:text-xl text-sm pb-1'>123123123123</p>
                                <div className='flex items-center md:gap-0 gap-3'>
                                    ...
                                    <p className='text-black md:text-xl text-sm font-semibold'>Bandung</p>
                                </div>
                    ...
                    <div className=' md:w-3/6  flex'>
                        ...
                        <div className='w-full py-14 md:px-20 px-5 grid grid-rows-3 gap-5 items-center'>
                            <div className='flex'>
                                ...
                                <p className='md:text-xl text-sm'>Pt. Travel Kerens Dongs Indonesia</p>
                            </div>
                            <div className='flex'>
                                <div className='md:w-1/12 w-2/12'>
                                    <Image
