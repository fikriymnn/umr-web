        ...
        <div className="w-8/12">
          <div className=" bg-white w-10/12 h-[681px] ms-20 rounded-xl">
            <div className="h-[60px] rounded-t-xl center">
              <p className="text-xl text-bold text-center pt-3 text-black">
            ...
            <div className="grid grid-cols-2 gap-5 p-7">
              <div className="flex">
                ...
                <div>
                  <p className="ps-1 font-bold text-xl text-black">
                    Pilihan Kamar
                  </p>
                  <p className="ps-1 pt-2 text-xl text-black">
          ...
          <div className="bg-white w-10/12 ms-20 rounded-xl">
            ...
            <div className="flex py-7 px-14">
              ...
              <div className="w-full ps-5">
                <h1 className=" text-black text-4xl pb-3 font-semibold">
                  Travel Keren Dongs
                </h1>
          ...
          <div className="bg-white w-10/12 ms-20 rounded-xl">
            ...
            <div className="flex py-7 px-14">
              ...
              <div className="w-full ps-5">
                <h1 className=" text-black text-4xl pt-[40px] font-semibold">
                  Air Asia Airlines
                </h1>
              </div>
            </div>
        ...
        <div className="w-4/12 z-10 mr-20">
          <div className="bg-white rounded-xl">
            <div className="p-7">
              ...
              <div className="px-5">
                <h2 className="text-3xl text-[#E3B02B] font-semibold pt-2">
                  RP 39.500.000
                </h2>
              </div>
              <div>
